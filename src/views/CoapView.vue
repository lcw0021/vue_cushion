            ...
            <el-row :gutter="20">
              ...
              <el-col :span="8">
                <el-form-item prop="port" label="Port">
                  <el-input v-model.number="connection.port" type="number" placeholder="5683"></el-input>
                </el-form-item>
              </el-col>
...
const SCHMEA_URL = "http://161.122.38.142:8080/cushion.json";
    ...
    createConnection() {
      ...
      for(var j=0 ; j<29 ; j++){
          for(var k=0; k<15; k++){
            ...
            newArray[j].data[k] = this.newDataArray[(j*15)+k+2];
            arr_temp.push( {"properties": {"current": newArray[j].data[k], "coord":{"properties": {"x":k, "y":j}} } } );
          }
      }
